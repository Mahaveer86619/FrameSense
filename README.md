...
⚙️ Microservices architecture (Go + Python)

☁️ AWS-like infrastructure using LocalStack
...
Creative Commons short films

AI-generated clips

Self-recorded dialogue scenes

No copyrighted or DRM-protected media is used.

🧪 Project Status

This is a research & portfolio project designed to demonstrate:
...
It is not intended for production advertising use.

📌 Resume Summary

Built an AI-aware video streaming platform using Go and Python that injects contextual in-scene advertisements via server-side HLS stream manipulation, subtitle-based scene analysis, and microservice-driven AI ad generation.

🔮 Future Enhancements

Real ML-based scene detection

Live stream support

User-personalized ad selection

Interactive overlay ads

WebAssembly-based client overlays
...
This project focuses on improving user experience, not deceptive advertising.
